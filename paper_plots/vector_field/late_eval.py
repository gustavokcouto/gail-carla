...
train_vector_field = train_vector_field[train_vector_field['ep_count'] == 36]
train_vector_field_end_episode = train_vector_field[(train_vector_field['color'] == False)]
train_vector_field = train_vector_field.iloc[::10, :]
...
fig.savefig('paper_plots/vector_field/late_eval.png')
fig.savefig('paper_plots/vector_field/late_eval.eps')