...
class RolloutStorage(object):
    ...
    def insert(self, obs, metrics, recurrent_hidden_states, actions, action_log_probs,
    ...
    def feed_forward_generator(self,
        ...
        for indices in sampler:
            ...
            yield obs_batch, metrics_batch, recurrent_hidden_states_batch, actions_batch, \
    ...
    def recurrent_generator(self, advantages, num_mini_batch):
        ...
        for start_ind in range(0, num_processes, num_envs_per_batch):
            ...
            for offset in range(num_envs_per_batch):
                ...
                metrics_batch.append(self.metrics[:-1, ind])
            ...
            metrics_batch = torch.stack(metrics_batch, 1)
            ...
            metrics_batch = _flatten_helper(T, N, metrics_batch)
